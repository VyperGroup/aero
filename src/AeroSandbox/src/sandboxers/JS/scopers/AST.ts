import { astParser, astWalker, ASTRewriterConfig } from "$aero/types";
...
var INCLUDE_AST_PARSER_OXC: boolean, INCLUDE_AST_PARSER_SEAFOX: boolean;
var INCLUDE_AST_WALKER_TRAVERSE_THE_UNIVERSE: boolean;
